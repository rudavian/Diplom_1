...
from helpers import make_ingredient
...
class TestBurger:
    ...
    def test_move_ingredient_moves_ingredient_to_new_index(self, burger):
        first_ingredient = make_ingredient(name="cutlet")
        second_ingredient = make_ingredient(name="sauce")
    ...
    def test_get_receipt_returns_burger_receipt(self, burger, bun):
    ...
    def test_burger_uses_real_database_items(self):
        database = Database()
        burger = Burger()
    ...
    def test_bun_returns_name_and_price(self):
        bun = Bun("white bun", 200)

        assert bun.get_name() == "white bun"
        assert bun.get_price() == 200

    def test_ingredient_returns_type_name_and_price(self):
    ...
    def test_praktikum_main_prints_burger_receipt(self, capsys):
